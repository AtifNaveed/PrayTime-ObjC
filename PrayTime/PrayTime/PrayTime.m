...
// Reference: http://praytimes.org
// ObjC: http://praytimes.org/code/git/?a=tree&p=PrayTimes&hb=HEAD&f=v1/objc
...
-(id) init {
    ...
    if(self){
        ...
        [methodParams setObject:Jvalues forKey:[NSNumber numberWithUnsignedInteger:Jafari]];
        ...
        [methodParams setObject:Kvalues forKey:[NSNumber numberWithUnsignedInteger: Karachi]];
        ...
        [methodParams setObject:Ivalues forKey:[NSNumber numberWithUnsignedInteger: ISNA]];
        ...
        [methodParams setObject:Mvalues forKey:[NSNumber numberWithUnsignedInteger: MWL]];
        ...
        [methodParams setObject:Mavalues forKey:[NSNumber numberWithUnsignedInteger: Makkah]];
        ...
        [methodParams setObject:Evalues forKey:[NSNumber numberWithUnsignedInteger: Egypt]];
        ...
        [methodParams setObject:Tvalues forKey:[NSNumber numberWithUnsignedInteger: Tehran]];
        ...
        [methodParams setObject:Cvalues forKey:[NSNumber numberWithUnsignedInteger: Custom]];
...
-(void)setCustomParams: (NSMutableArray*)params {
    int i;
    id j;
    id Cust = [methodParams objectForKey: [NSNumber numberWithUnsignedInteger:Custom]];
